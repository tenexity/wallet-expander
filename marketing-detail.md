# Wallet Share Expander - Marketing Pitch Plan
...
**Key Differentiator:** We don't replace human relationships—we enhance them. AI does the analysis and preparation; your team builds the trust that closes deals.
...
Your existing customers hold untapped potential. Our AI analyzes your entire customer base to surface the accounts with the highest wallet share growth opportunity—accounts your team might be overlooking.
...
When you enroll an account, you're not hoping for growth—you're activating a proven system. Every enrolled account receives a customized action plan designed to expand their wallet share.

**Supporting Messages:**
- Enrollment is a commitment—and so is our system
...
We don't replace your sales team—we supercharge them. AI handles the analysis, preparation, and script generation. Your people bring the relationship expertise that closes deals.
...
**Expanded Messaging for Campaigns:**
- "Enrollment isn't a wish—it's a system."
...
**Expanded Messaging for Campaigns:**
- "Know the exact dollar amount you're leaving on the table—by category."
...
**Expanded Messaging for Campaigns:**
- "Finally—proof that your sales efforts are working."
...
- "94% graduate. That's not a goal—it's a track record."
...
*Response:* Start with a pilot. Enroll 20 accounts. If 90%+ don't show measurable growth in 90 days, we've failed. Our track record says otherwise—but let's prove it with your data.
...
### Tone
- **Confident but not arrogant** — We have a track record, but we let the numbers speak
- **Direct and actionable** — Clear language, no jargon
- **Empowering, not replacing** — AI enhances humans, not replaces them
- **Results-focused** — Every message ties back to growth

### Words We Use
- Enroll (not "sign up" — enrollment is intentional)
...
### Primary CTA
"Start Free Trial" — Low commitment, immediate access

### Secondary CTA
"See How It Works" — Educational journey for research phase

### Tertiary CTA
"Schedule a Demo" — For larger deals or hands-on prospects
...
### Color Associations
- Teal/Blue — Trust, intelligence, technology
- Green — Growth, success, money
- White — Clean, professional, clarity
